...
while running:
    ...
    for robot in robots:
        robot.move()
        robot.vxg = 40*(1+robots.index(robot))
        robot.theta_d = -(robot.sensor_data[len(environment.edge_distances)-1] - robot.sensor_data[1])*0.01*(1+robots.index(robot))
        ...
        print('robot:',robots.index(robot))
